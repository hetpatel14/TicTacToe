        ...
        while (!this.done) {
            ...
            switch (nextInt) {
                ...
                case 2: {
                    ...
                    scanner.next().trim();
                    System.out.println("HetBot: yeah...right! you many not name me... I AM KobtiBot");
                    System.out.println("HetBot: don't worry " + s + ", my level of difficulty is set to NOVICE!\n");
                    str = "HetBot";
                    this.done = true;
                    continue;
                }
